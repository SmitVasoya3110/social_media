...
def invites_received_view(request):
    profile = Profile.objects.get(user=request.user)
    qs = Relationship.objects.ivitation_received(profile)
    ...
    return render(request,'user_profile/my_invites.html',context)
...
def accept_invitation(request):
    if request.method == 'POST':
        ...
        if rel.status == 'send':
            rel.status ='accepted'
            rel.save()
    return redirect('user_profile:my-invites-view')
...
def invite_profiles_list_view(request):
    ...
    return render(request,'user_profile/invite_list.html',context)
...
def send_invitation(request):
    ...
    return redirect('user_profile:my-profile-view')
